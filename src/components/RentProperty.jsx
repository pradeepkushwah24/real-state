...
import { FaSearch, FaMapMarkerAlt, FaBed, FaBath, FaVectorSquare, FaFilter, FaTimes, FaHome, FaBuilding, FaStore, FaTree, FaArrowRight, FaStar, FaEye, FaRupeeSign } from 'react-icons/fa'
...
const RentProperty = () => {
  ...
  const loadProperties = async () => {
    try {
      const response = await getProperties('rent')
      let data = response.data.data || []
      data = data.filter(p => p.purpose === 'rent')
      setProperties(data)
  ...
  const categories = [
    { id: 'all', name: 'All Rentals', icon: FaHome, count: properties.length },
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <h1 style={styles.title}>
          Properties for <span style={styles.titleAccent}>Rent</span>
        </h1>
        <p style={styles.subtitle}>
          Find your perfect rental home from our curated collection of premium listings
        </p>
      </div>
      ...
      <div style={styles.resultsInfo}>
        <div style={styles.resultsCount}>
          ...
          <strong>{filteredProperties.length}</strong> rental properties found
      ...
      {filteredProperties.length === 0 ? (
        <div style={styles.emptyState}>
          ...
          <h3 style={{ color: colors.dark, marginBottom: '10px' }}>No rental properties found</h3>
